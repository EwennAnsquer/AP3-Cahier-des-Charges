 ...
 */
final class Version20231214072111 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, le_compte_utilisateur_id INT DEFAULT NULL, la_ville_id INT DEFAULT NULL, le_pays_id INT DEFAULT NULL, prenom_acheteur VARCHAR(255) NOT NULL, nom_acheteur VARCHAR(255) NOT NULL, volume INT NOT NULL, poids INT NOT NULL, date_livraison DATETIME NOT NULL, etat VARCHAR(255) NOT NULL, adresse VARCHAR(255) NOT NULL, numero_telephone VARCHAR(255) NOT NULL, numero_suivi VARCHAR(13) NOT NULL, INDEX IDX_6EEAA67D9906B190 (le_compte_utilisateur_id), INDEX IDX_6EEAA67D609A8BA5 (la_ville_id), INDEX IDX_6EEAA67D892B3433 (le_pays_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
