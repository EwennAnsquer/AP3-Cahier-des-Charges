 ...
 */
final class Version20231211130504 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE compte_utilisateur (id INT AUTO_INCREMENT NOT NULL, le_type_notification_id INT NOT NULL, le_centre_relais_colis_defaut_id INT DEFAULT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, is_register TINYINT(1) NOT NULL, register_number INT NOT NULL, register_date DATETIME NOT NULL, UNIQUE INDEX UNIQ_310DE9E7E7927C74 (email), INDEX IDX_310DE9E798D9D7D3 (le_type_notification_id), INDEX IDX_310DE9E713A11F0B (le_centre_relais_colis_defaut_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE ville (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, code_postal INT NOT NULL, pays VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
