 ...
 */
final class Version20231204130610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE centre_relais_colis (id INT AUTO_INCREMENT NOT NULL, adresse VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, code_postal INT NOT NULL, pays VARCHAR(255) NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE commande (id INT AUTO_INCREMENT NOT NULL, le_compte_utilisateur_id INT DEFAULT NULL, pays VARCHAR(255) NOT NULL, prenom_acheteur VARCHAR(255) NOT NULL, nom_acheteur VARCHAR(255) NOT NULL, code_postal INT NOT NULL, ville VARCHAR(255) NOT NULL, numero_telephone INT NOT NULL, volume INT NOT NULL, poids INT NOT NULL, date_livraison DATETIME NOT NULL, etat VARCHAR(255) NOT NULL, INDEX IDX_6EEAA67D9906B190 (le_compte_utilisateur_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE compte_utilisateur (id INT AUTO_INCREMENT NOT NULL, le_type_notification_id INT NOT NULL, email VARCHAR(180) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, is_register TINYINT(1) NOT NULL, register_number INT NOT NULL, id_centre_relais_defaut INT DEFAULT NULL, UNIQUE INDEX UNIQ_310DE9E7E7927C74 (email), INDEX IDX_310DE9E798D9D7D3 (le_type_notification_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
